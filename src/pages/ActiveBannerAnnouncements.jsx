        ...
        {banners.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm p-6 text-center">
            ...
            <p className="text-gray-500">
              For offers and updates, check back later!
            </p>
          </div>
        ) : (
                  ...
                  {banner.imageUrl && (
                    <div className="md:flex-shrink-0">
                      <img
                        ...
                        onError={(e) => {
                          e.target.src =
                            "https://images.pexels.com/photos/214659/pexels-photo-214659.jpeg?auto=compress&cs=tinysrgb&w=800";
                        }}
                      />
                    </div>
                  )}
