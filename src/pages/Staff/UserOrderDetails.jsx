...
import { CheckCircle, XCircle, Search, Boxes, ChevronUp, ChevronDown, Trash2 } from 'lucide-react';
...
function OrderDetails() {
    ...
    const handleDeleteOrder = async (orderId) => {
        try {
            const endpoint = 'api/Orders/delete-order';
            const response = await apiClient.post(endpoint, { orderId }, {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    return (
        <div className="container  px-4 py-8">
            <div className="flex flex-col lg:flex-row ">
                ...
                <div className="max-w-7xl  px-2 sm:px-6 lg:px-2 py-8">
                                                        ...
                                                        <td colSpan="7" className="px-6 py-4 bg-gray-50">
                                                            <div className="space-y-4">
                                                                <div className="flex justify-between text-sm text-gray-600">
                                                                    <span>Bill Amount: Rs {order.billAmount.toFixed(2)}</span>
                                                                    <span>Discount: Rs {order.discountApplied.toFixed(2)}</span>
                                                                    <span>Final Amount: Rs {order.finalAmount.toFixed(2)}</span>
                                                                </div>
                                                                <table className="min-w-full divide-y divide-gray-200">
                                                                    <thead>
